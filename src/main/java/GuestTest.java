...
import hostel.app.model.Address;
import hostel.app.model.Reservation;
import hostel.app.model.Date;
import java.util.*;
public class GuestTest {
    public static void main(String[] args) {
        ...
        reservation1.setChekinDate(checkinDate1);
        ...
        reservation2.setChekinDate(checkinDate2);
